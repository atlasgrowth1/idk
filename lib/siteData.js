...
const sites = {
  ...
  "chicago": {
    name: "Chicago Electrical Pros",
    phone: "+1 312-555-7890",
    email_1: "chicago@yourelectrician.com",
    city: "Chicago",
    state: "IL",
    rating: 4.9,
    reviews: 87
  ...
  "newyork": {
    name: "NYC Electrical Services",
    phone: "+1 212-555-3456",
    email_1: "nyc@yourelectrician.com",
    city: "New York",
    state: "NY",
    rating: 4.8,
    reviews: 124
...
export function getSiteData(site) {
  return sites[site] || sites.default;
}
